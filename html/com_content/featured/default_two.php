...
<div class="box_news_content <?php echo $no_image ?>" itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
...
<div class="category_news">
	<?php if ($params->get('show_category') == '1') : ?>
		<a href="<?php echo Route::_(RouteHelper::getCategoryRoute($this->item->catid, $this->item->language)); ?>"><?= $this->item->category_title?></a>
	<?php endif;?>
</div>
