...
$box_info =  (($params->get('show_create_date') != '0' && $attribs->show_create_date != '0') || ($params->get('show_modified_date') != '0' && $attribs->show_modify_date != '0') || ($params->get('show_publish_date') != '0' && $attribs->show_publish_date != '0') || ($params->get('show_author') != '0' && $attribs->show_author != '0')) ? '' : ' not-info';
...
<?php  ?>
<div class="box_news version_one <?php echo $box_info.$no_image?> ">
...
<div class="box_content_news row">
	...
	<?php if ($params->get('show_category') == '1') : ?>
		<div class="category_news"><a href="<?php echo Route::_(RouteHelper::getCategoryRoute($this->item->catid, $this->item->language)); ?>"><?= $this->item->category_title?></a></div>
	<?php endif;?>
</div>
<div class="col-md-8 cl-text">
