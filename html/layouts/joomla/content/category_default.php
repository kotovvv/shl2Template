	...
	<?php if ($beforeDisplayContent || $afterDisplayContent || $params->get('show_description', 1) || $params->def('show_description_image', 1)) : ?>
			...
			<?php if ($params->get('show_description_image') && $category->getParams()->get('image')) : ?>
								<div class="box_img_news">
										<img src="<?php echo $category->getParams()->get('image') ?>" alt="<?= empty($category->getParams()->get('image_alt')) && empty($category->getParams()->get('image_alt_empty')) ? false : $category->getParams()->get('image_alt') ?>">
									</div>
								<?php endif; ?>
								<div>
